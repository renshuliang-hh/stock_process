...
def match_index(name,year,add_data):
    ...
    return data_1
data=pd.read_csv('new_pr_result\\pr_stock_lr_i_ONLY_GDP.csv')
#
...
data_corrected.to_csv('new_pr_result_corrected\\ONLY_GDP_add_pr_stock_lr_i_corrected_everyear_2.csv',index=None)
data.to_csv('new_pr_result_corrected\\ONLY_GDP_add_pr_stock_lr_i_corrected_2.csv',index=None)
